...
```r
traincsv <- read.csv("E:/pml-training.csv")
testcsv <- read.csv("E:/pml-testing.csv")
...
Github Repo: [Github](https://github.com/Laxmi530/Practical-Machine-Learning)
